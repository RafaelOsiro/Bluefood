...
import io.ucb.rafael.bluefood.application.service.RelatorioService;
...
import io.ucb.rafael.bluefood.domain.pedido.RelatorioItemFaturamento;
import io.ucb.rafael.bluefood.domain.pedido.RelatorioItemFilter;
import io.ucb.rafael.bluefood.domain.pedido.RelatorioPedidoFilter;
...
public class RestauranteController {
	...
	public String viewComidas(Model model) {
		...
		List<ItemCardapio> itensCardapio = itemCardapioRespository.findByRestaurante_IdOrderByNome(restauranteId);
	...
	public String remover(@RequestParam("itemId") Integer itemId, Model model) {
		itemCardapioRespository.deleteById(itemId);
